...
#[ORM\Index(columns: ['queuepretaskid'], name: 'queuepretaskid')]
...
class QueuePreTask
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column(options: ['comment' => 'Queuepretask ID', 'unsigned' => true])]
    private int $queuepretaskid;

    #[ORM\ManyToOne(inversedBy: 'queuePreTasks')]
    ...
    public function getQueuePreTaskid(): int
    {
        return $this->queuepretaskid;
    }

    public function setJudging(Judging $judging): QueuePreTask
    {
    ...
    public function setPriority(int $priority): QueuePreTask
    {
    ...
    public function setTeamPriority(int $teamPriority): QueuePreTask
    {
    ...
    public function setTeam(?Team $team = null): QueuePreTask
    {
        $this->team = $team;
        return $this;
    }
    ...
    public function setStartTime(?float $startTime = null): QueuePreTask
    {
